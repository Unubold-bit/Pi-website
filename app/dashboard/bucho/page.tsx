      ...
      <nav style={{ background: "#111", borderBottom: "1px solid #1f1f1f", padding: "0 24px", height: "56px", display: "flex", alignItems: "center", justifyContent: "space-between", position: "sticky", top: 0, zIndex: 100 }}>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: "12px" }}>
          ...
          <button 
            ...
            style={{ background: "transparent", border: "1px solid #ef4444", color: "#ef4444", borderRadius: "4px", padding: "4px 12px", cursor: "pointer", fontSize: "12px" }}
            >
            {t.logout}
          </button>        
          </div>
              ...
              <div key={req.id} style={{ background: uc.bg, border: `1px solid ${uc.border}`, borderRadius: "4px", padding: "20px" }}>
                ...
                <div style={{ display: "flex", gap: "8px" }}>
                  ...
                  <button 
                    ...
                    style={{ padding: '10px 14px', borderRadius: "4px", border: "1px solid #1f1f1f", background: "transparent", color: "#666", fontSize: "12px", cursor: "pointer" }}
                  >
                    {t.viewDetail}
                  </button>
                </div>
